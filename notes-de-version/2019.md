...
## v2019.5.2 rev 2 - 28/10/2019

### 🔐 Sécurité

* Mise à jour de l'image 🐳 Docker.
  * Mise à jour de **php** vers la version **7.3.11** pour corriger de multiples vulnérabilités \(avis [CERTFR-2019-AVI-534](https://www.cert.ssi.gouv.fr/avis/CERTFR-2019-AVI-534/)\).

## v2019.5.2 - 30/09/2019
