...
* Le système de paiement a été mis à jour pour être conforme au [règlement UE 2018/389](https://eur-lex.europa.eu/legal-content/FR/TXT/PDF/?uri=CELEX:32018R0389&from=FR) de la DSP2 \(Directive sur les Services de Paiements\) imposant notamment l'authentification forte du client pour les paiements par carte bancaire 💳 supérieurs à 30€ et qui entrera en action à partir du 14 Septembre 2019 \(vous êtes maintenant redirigés vers Stripe pour la partie paiement\).
* Le bloc **Mon abonnement** de la page **Mon compte** vous informe désormais sur la date de prochain renouvellement de votre abonnement personnel \(date de prochaine facture\).
