...
* Mise à jour de l'image 🐳 Docker vers la branche Alpine 3.9.x \(résolution de la vulnérabilité [CVE-2018-19486](https://nvd.nist.gov/vuln/detail/CVE-2018-19486) dans git\).
